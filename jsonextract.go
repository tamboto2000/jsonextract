...
// This package did not guarantee 100% success rate of parsing JSON, so it is highly recommended to check if the JSONs that you get is valid,
// call Valid() to get which JSONs is valid and which not.
package jsonextract
